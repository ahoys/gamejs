...
class Game {
  ...
  handleControlActions(active) {
    const actions = {
      ...
      'CAM_MOVE_-Z': () => this._camera.doMoveZ(-Calc.getRelativeSpeed(this._tickLength, 10)),
      'CAM_ROTATE_+X': () => this._camera.doRotateX(Calc.getRelativeSpeed(this._tickLength, 20)),
      'CAM_ROTATE_-X': () => this._camera.doRotateX(-Calc.getRelativeSpeed(this._tickLength, 20)),
      'CAM_ROTATE_+Y': () => this._camera.doRotateY(Calc.getRelativeSpeed(this._tickLength, 20)),
      'CAM_ROTATE_-Y': () => this._camera.doRotateY(-Calc.getRelativeSpeed(this._tickLength, 20)),
